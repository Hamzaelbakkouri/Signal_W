...
function Signal_callback()
{
    ...
    <form class="form" id="form">
        <div>
            ...
            <label class="labelForm" for="prenom">add your First Name:</label>
        </div>
        <div>
            <input type="radio" name="nom" id="nom">
            <label class="labelForm" for="nom">Add your Last name :</label>
        </div>
        <div>
            <input type="radio" name="email" id="email">
            <label class="labelForm" for="email">add an Email:</label>
        </div>
        <div>
            <input type="radio" name="raison_signal" id="raison_signal">
            <label class="labelForm" for="raison_signal">signal reasons:</label>
        </div>
        <div>
        ...
        <div>
            ...
            <label class="labelForm" for="commentaire">add comments:</label>
        </div>
        <div>
